...
CANNED_RESPONSES = {
    "What is your current research focus?": (
        "Berardino's current research focus includes leading AI research in computer vision and causal machine learning "
        "at McGill University and Mila AI Institute in Montréal. His work involves trajectory prediction, counterfactual "
        "image synthesis, biomarker discovery, and drug efficacy prediction. Berardino utilizes LLMs for zero-shot prediction "
        "and causal reasoning in longitudinal disease modeling. He combines image and tabular embeddings to simulate treatment "
        "effects and manage risk."
    ),
}
...
if st.session_state.show_canned and query.strip() in CANNED_RESPONSES:
    st.info(CANNED_RESPONSES[query.strip()])
